<footer class="mx-auto px-4 md:px-8">
    <div class="border-t border-b py-6">
        <div class="flex flex-col items-center justify-between gap-4 max-w-7xl mx-auto py-6 md:flex-row">
            <!-- nav - start -->
            <nav class="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 md:justify-start md:gap-6">
                <a href="{{ route('about.index') }}"
                    class="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">About</a>
                <a href="{{ route('contacts.index') }}"
                    class="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Contacts</a>
            </nav>
            <!-- nav - end -->
